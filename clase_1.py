...
# este_es_un_numero =  55
# print(este_es_un_numero)

# print(type(este_es_un_numero))

# este_es_un_numero_con_coma = 2.98

# print(type(este_es_un_numero_con_coma))

# print(34)
# print(type(56.32))

# #String. Son una cadena de caracteres.

# esto_es_una_palabra = "Matias"

# print(esto_es_una_palabra)
# print(type(esto_es_una_palabra))

# #Boolean. Es un estado que es verdadero o falso.
# print( 1 == True)
...
print(f'Esta es una string que contiene una variable {n1}')
...
print(f'n1 igual a n2 {n1 == n2}')

print("Ignacio" == "Ignacio")
